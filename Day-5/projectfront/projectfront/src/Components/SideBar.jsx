  ...
  return (
    ...
    <div className="sidebar">
      ...
      <ul className="sidebar-menu">
        ...
        <li><button className='button'> CART</button></li>
        <li><button className='button'> PAYMENT</button></li>
